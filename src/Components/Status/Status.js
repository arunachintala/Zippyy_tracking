...
function Status() {
    return (
        <div style={{ marginLeft: '30px', width: 'auto', height: 'auto', }}><p style={{ fontFamily: 'Poppins', fontWeight: '600', fontSize: '16px', lineHeight: '24px', color: '#121114' }}>Tracking Status</p>
